...
const Header = () => {
  ...
  const openBookingPage = () => {
    window.location.href =
      "https://apps.hti-systems.com/hostech/tafaria/desktop.html?locale=en_US";
  };
    ...
    <div>
        ...
        <div className="container mx-auto flex items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-3">
            <div className="hidden  items-center space-x-4   md:flex ">
              ...
              >
                <FaFacebookF
                  className="text-white bg-[#902729] rounded-full p-2 "
                  size={28}
                />
              </a>
              <a
                href="https://x.com/tafariacastle?lang=en"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaTwitter
      ...
      <IoLocation className="lg:text-4xl sm:text-sm md:text-2xl text-[#902729]"/>
            ...
            <button
              ...
              className="bg-[#94723C] text-white px-5 py-2 text-sm sm:text-base sm:px-6 sm:py-2 rounded-md font-semibold hover:bg-[#902729]"
            >
              Book
            </button>
          </div>
